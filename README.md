...
- **Текстовий режим** - для тих хто віддає перевагу тексту
- **Пам'ять розмови** - бот пам'ятає контекст попередніх повідомлень
- **Голосове розпізнавання команд** - бот має LLM-модуль для розпізнавання команд
...
| Розпізнавання мовлення | OpenAI Whisper           |
...
Повідомлення користувача
  ...
  (відповідь)      (Поки що тільки зміна імен)
        │
        ▼
  [пошук в інтернеті]
  [аналіз зображення]
